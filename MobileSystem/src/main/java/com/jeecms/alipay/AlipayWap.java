 ...
 */
@RestController
@RequestMapping(value = "alipaywap")
public class AlipayWap {
    ...
    public static String notify_url = "http://a5264431.ngrok.io/alipaywap/notify";
    // 页面跳转同步通知页面路径,需要http://格式的完整路径,必须外网可以访问
    public static String return_url = "http://a5264431.ngrok.io/return.html";
     ...
     */
     ...
     public void notify(HttpServletRequest request, HttpServletResponse response) throws AlipayApiException, IOException {
         ...
         if(signVerified) {//验证成功
             ...
             if(trade_status.equals("WAIT_BUYER_PAY")){//交易完成
